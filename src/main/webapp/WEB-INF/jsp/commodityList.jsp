...
<script type="text/javascript">
 	$(document).ready(function(){
 		 $(".tiptop a").click(function(){
 	  	 ...
 	  	 $(".sure").click(function(){
 	        $.ajax({
 				url : "${pageContext.request.contextPath}/deleteCommodity?id="+$("#saveId").val(),
 				type : 'post',
 				async : false, 
 				success : function(objs) {
 					if(objs.result==1){
 						window.location.href="${pageContext.request.contextPath}/commodityList";
 					}else{
 						alert(objs.message);
 					}
 				}
 	...
 	function modifyCommodity(id) {
 		window.location.href="${pageContext.request.contextPath}/updateCommodityBefore?id="+id;
 	}
 	...
 	function addCommodity(){
 		window.location.href="${pageContext.request.contextPath}/addCommodityBefore"
 	}
 	
	function getPage(pageCount){
		window.location.href="${pageContext.request.contextPath}/commodityList?pageCount="+pageCount
	}
	$(function(){
...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li onclick="addCommodity()"><span ><img src="${pageContext.request.contextPath}/static/images/t01.png" /></span>添加</li>
        </ul>
        ...
        <c:forEach items="${commoditys }" var="commodity">
        	<tbody>
        	 <tr>
		        ...
		        <td><a href="javaScript:void(0)" onclick="modifyCommodity('${commodity.id}')" class="tablelink">修改</a><a href="javaScript:void(0)" class="tablelink" onclick="delCommodity('${commodity.id}')"> 删除</a></td>
	        </tr> 
	        </tbody>
        </c:forEach>
