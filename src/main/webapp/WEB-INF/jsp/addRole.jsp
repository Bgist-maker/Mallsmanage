...
<body>
    ...
    <li><a href="${pageContext.request.contextPath}/addRoleBefore">添加角色</a></li>
    </ul>
    </div>
    ...
    <ul class="forminfo">
    <form action="${pageContext.request.contextPath}/addRole" method="post" id="form1">
	    <li><label>角色名称</label><input name="name" type="text" class="dfinput" /><font style="color: red">&nbsp;&nbsp;&nbsp;*</font>
	    </li>
    </form>
