...
<body>
    ...
    <li><a href="${pageContext.request.contextPath}/addOperationBefore">出入库操作</a></li>
    </ul>
    </div>
    ...
    <ul class="forminfo">
    <form action="${pageContext.request.contextPath}/addOperation" method="post" id="form1">
   		 <li>
	    	<label>商品</label>
    		<select id="commodityid" name="commodityid">
			</select>
	    </li>
	    <li><label>数量</label><input name="amount" type="text" class="dfinput"/><font style="color: red">&nbsp;&nbsp;&nbsp;*</font>
	    </li>
	     <li>
	    	<label>类型</label>
	    ...
	    <li><label>备注</label><input name="remark" type="text" class="dfinput"/>
	    </li>
    </form>
