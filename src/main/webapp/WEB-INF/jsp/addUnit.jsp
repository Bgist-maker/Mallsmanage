...
<body>
    ...
    <li><a href="${pageContext.request.contextPath}/addUnitBefore">添加计量单位</a></li>
    </ul>
    </div>
    
    <div class="formbody">
    
    <div class="formtitle"><span>添加计量单位</span></div>
    
    <ul class="forminfo">
    <form action="${pageContext.request.contextPath}/addUnit" method="post" id="form1">
