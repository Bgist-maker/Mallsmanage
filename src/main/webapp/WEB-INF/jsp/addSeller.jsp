...
<body>
    ...
    <li><a href="${pageContext.request.contextPath}/addSellerBefore">添加客户</a></li>
    </ul>
    </div>
    ...
    <ul class="forminfo">
    <form action="${pageContext.request.contextPath}/addSeller" method="post" id="form1">
	    <li><label>姓名</label><input name="username" type="text" class="dfinput"/><font style="color: red">&nbsp;&nbsp;&nbsp;*</font>
	    </li>
	    <li><label>所在单位</label><input name="company" type="text" class="dfinput" /><font style="color: red">&nbsp;&nbsp;&nbsp;*</font>
	    </li>
	    <li><label>生日</label><input name="birthday" type="date" class="dfinput" /><font style="color: red">&nbsp;&nbsp;&nbsp;*</font>
	    </li>
	    <li><label>联系电话</label><input name="phone" type="text" class="dfinput" /><font style="color: red">&nbsp;&nbsp;&nbsp;*</font>
	    </li>
	    <li><label>邮箱</label><input name="email" type="text" class="dfinput" /><font style="color: red">&nbsp;&nbsp;&nbsp;*</font>
	    </li>
