...
//	ECharts是百度团队开发的一个可以个性定制的数据可视化的图标库。数据可视化是指将数据以图形的形式进行显示。
        ...
        var option = {
         ...
         /*    formatter: function (params,ticket,callback) {
                    ...
                    var res = "";
                    $.ajax({
            			url : '${pageContext.request.contextPath}/cityAnalyz',
            			type : 'post',
        ...
        myChart.setOption(option);//将数据在图表中进行显示
      $.ajax({
			url : '${pageContext.request.contextPath}/numAnalyzBuy',
			type : 'post',
			async : false, //默认为true 异步   
			success : function(data) {
				debugger;
